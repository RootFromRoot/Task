...
class RepostsAdapret(var items: ArrayList<Data>): RecyclerView.Adapter<LikesViewHolder>()  {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LikesViewHolder {
        return LikesViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_list_reposts, parent, false))
    }

    fun setReposts(likes: ArrayList<Data>) {
        this.items = likes
